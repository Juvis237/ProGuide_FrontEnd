...
import { TrashIcon, FilePlusIcon, CameraIcon, OpenInNewWindowIcon } from '@radix-ui/react-icons';
...
const UploadDocuments: React.FC = () => {
    ...
    return (
        <div className="flex flex-col">
            ...
            {files.length > 0 && (
                <div className="w-full min-w-[366px] bg-white p-4 mt-4 rounded shadow-md">
                    ...
                    <div className="flex justify-end mt-4">
                        <button onClick={() => setFiles([])} className="bg-gray-300 text-black p-2 rounded mr-2">
                            Cancel
                        </button>
                        <button onClick={handleUpload} className="bg-orange-500 text-white p-2 rounded">
