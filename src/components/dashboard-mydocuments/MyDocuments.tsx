...
const MyDocuments: React.FC = () => {
    ...
    return (
        <div className="px-4 flex flex-col items-center">
            ...
            />
            <div className="relative min-w-[400px] w-90% top-[94px] left-[1px] gap-[0px] rounded-tl-[30px] rounded-tr-[30px] rounded-bl-[0px] rounded-br-[0px] bg-white p-4">
                {selectedDocument ? (
                    ...
                    <div className='w-full min-w-[366px]'>
                        {myDocumentData.length > 0 ? (
                            ...
                            <div className="w-full rounded-2xl box-shadow flex justify-between items-center sm:flex-col p-4 mt-3">
