...
const SignupForm = () => {
    ...
    // Initialize the form with default values, including the referral code
    const form = useForm<z.infer<typeof signupSchema>>({
        resolver: zodResolver(signupSchema),
        defaultValues: {
            username: '',
            referal_code: searchParams.get('referral') || '', // Set the referral code here
        },
    })
    ...
    const onSubmit = async (values: z.infer<typeof signupSchema>) => {
        ...
        const requestBody = JSON.stringify({
            ...
            referal_code: values.referal_code, // The referral code is now included in the request body
    ...
    return (
        <div className="img-bg sm:bg-primary h-full flex flex-col items-center justify-center pt-[9rem] sm:pt-4">
            <Header
                title={headerSignup}
